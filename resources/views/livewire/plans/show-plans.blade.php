<div class="py-8">
            ...
            <div class="border rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300 bg-white relative overflow-hidden transform hover:-translate-y-1
                ...
                @auth
                    <a href="{{ route('checkout', $plan) }}"
                       class="w-full bg-indigo-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-indigo-700 transition-colors duration-300 flex items-center justify-center">
                ...
                @else
                    <a href="{{ route('login') }}"
                       class="w-full block bg-gray-200 text-gray-800 px-6 py-3 rounded-lg font-medium hover:bg-gray-300 transition-colors duration-300 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="mt-12 text-center text-gray-600 max-w-lg mx-auto">
        <p class="text-sm">Alle abonnementen omvatten 30 dagen geld-terug garantie, 24/7 ondersteuning en gratis
            updates.</p>
    </div>
</div>
